...
### associating text with metadata and setting threshold. Here we only keep words that appear in at least 5 documents
...
plot(prep, covariate ="source", topics = c(1:10), model = k10, method = "difference", cov.value2 = "Donald Trump", cov.value1 = "Hillary Clinton", xlab = "Donald Trump.... Hillary Clinton", main = "Post Source: Trump vs. Hillary", xlim=c(-.3,.3))
...
plot.estimateEffect(prep1, "days", method = "continuous", topics = 2, printlegend = T, xaxt = "n", xlab = "2016")
